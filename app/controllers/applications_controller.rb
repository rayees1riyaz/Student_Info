class ApplicationsController < ApplicationController
  ...
  def new
    if current_user.applications.exists?
      redirect_to index_path, alert: "You have already applied!"
    else
  ...
  def create
    ...
    if @application.save
      redirect_to index_path, notice: "Application submitted! Your Application Number: #{@application.application_number}"
    else
      render :new
    end
  end
